    ...
    <div class="form-group mandatory">
        ...
        <div class="row">
            <div class="col-8" style="padding-right: 0;">
                ...
                <input type="text" class="form-control" value="{{Route::is('admin.pembina.edit*') ? $data->user_group->name : ''}}" id="inputUserGroupName" readonly>
                <input type="text" class="d-none" value="{{Route::is('admin.pembina.edit*') ? $data->user_group->id : ''}}" name="user_group" id="inputUserGroupId">
            </div>
    ...
    <script>
        ...
        $('#filterUserGroup').on('show.bs.modal', function(event) {
            ...
            var data_table_user = $('#datatableUserGroupModal').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.pembina.getDataUserGroup') }}',
                    dataType: "JSON",
                    type: "GET",
                },
                columns: [{
