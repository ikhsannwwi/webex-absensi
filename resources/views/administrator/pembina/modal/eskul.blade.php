    ...
    <div class="form-group mandatory">
        ...
        <div class="row">
            <div class="col-8" style="padding-right: 0;">
                ...
                <input type="text" class="form-control" id="inputEskulName" value="{{Route::is('admin.pembina.edit*') ? (array_key_exists('nama', $eskul) ? $eskul['nama'] : '') : ''}}" data-parsley-required="true" readonly>
                <input type="text" class="d-none" name="eskul" value="{{Route::is('admin.pembina.edit*') ? (array_key_exists('id', $eskul) ? $eskul['id'] : '') : ''}}" id="inputEskulId">
            </div>
