...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ template_administrator('assets/vendor/css/pages/page-auth.css') }}" />
  ...
  <body>
    ...
    <script src="{{ template_administrator('assets/vendor/libs/jquery/jquery.js') }}"></script>
